...
export default function ContactPage() {
  ...
  return (
    <SmoothScrollProvider>
      <div className="pt-32 pb-24 bg-ivory-100 min-h-screen space-y-16 md:space-y-20 text-charcoal-900 selection:bg-charcoal-900 selection:text-ivory-100">
        {/* Page Header */}
        ...
        <section className="px-6 sm:px-10 lg:px-16 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            {/* Form Column (7 Cols) */}
            <div className="lg:col-span-7 bg-ivory-200 border border-charcoal-900/10 p-8 sm:p-12 shadow-sm space-y-8">
              <div className="space-y-3 border-b border-charcoal-900/10 pb-6">
                ...
                <h2 className="font-serif text-2xl sm:text-3xl text-charcoal-900 font-light">
              ...
              {submitted ? (
                <motion.div
                  ...
                  className="py-16 text-center space-y-5 bg-ivory-100 border border-brass-400/40 p-8 shadow-sm"
                >
                  <CheckCircle2 className="w-12 h-12 text-brass-600 mx-auto" />
                  <h3 className="font-serif text-3xl text-charcoal-900">Inquiry Received</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 text-xs">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full bg-ivory-100 border border-charcoal-900/10 px-4 py-3.5 text-charcoal-900 placeholder-stone-400 focus:outline-none focus:border-brass-600 transition-colors"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        className="w-full bg-ivory-100 border border-charcoal-900/10 px-4 py-3.5 text-charcoal-900 focus:outline-none focus:border-brass-600 transition-colors"
                      >
                      ...
                      {["Immediate", "3–6 Months", "6–12 Months", "Concept Phase"].map((t) => (
                        <button
                          ...
                          className={`py-2.5 px-3 text-[11px] uppercase tracking-wider border transition-colors ${
                            formData.timeline === t
                              ? "bg-charcoal-900 text-ivory-100 border-charcoal-900 font-medium"
                              : "bg-ivory-100 text-stone-600 border-stone-300 hover:border-charcoal-900"
                          }`}
                        >
                          {t}
                        </button>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-ivory-100 border border-charcoal-900/10 p-4 text-charcoal-900 placeholder-stone-400 focus:outline-none focus:border-brass-600 transition-colors"
                    />
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 bg-charcoal-900 text-ivory-100 text-xs uppercase tracking-[0.25em] font-medium hover:bg-brass-600 transition-all duration-300 shadow-xl"
                  >
            ...
            <div className="lg:col-span-5 space-y-8">
              <div className="bg-[#0E0E0D] text-ivory-100 p-8 sm:p-10 border border-white/10 space-y-6">
                <span className="text-[10px] uppercase tracking-[0.35em] text-brass-400 font-medium">
                  Jaipur Atelier
                </span>

                <h3 className="font-serif text-2xl text-ivory-100 font-light">
                ...
                <div className="space-y-4 text-xs font-light text-stone-300">
                  ...
                  <div className="flex items-start space-x-3 border-t border-white/10 pt-4">
                    ...
                    <div>
                      ...
                      <p className="text-brass-400">inquiry@aarohstudio.com</p>
              ...
              <div className="bg-ivory-200 border border-charcoal-900/10 p-6 space-y-2">
            ...
            {FAQS.map((faq, idx) => {
              ...
              return (
                <div key={faq.q} className="py-6">
                  ...
                  >
                    <span className="font-serif text-lg sm:text-xl text-charcoal-900 group-hover:text-brass-600 transition-colors">
                      {faq.q}
                    </span>
                    <ChevronDown
                      className={`w-5 h-5 text-brass-600 transition-transform duration-300 shrink-0 ${
                        isOpen ? "rotate-180" : ""
                      }`}
                    />
                  </button>
                  <AnimatePresence>
                    {isOpen && (
                      ...
                      >
                        <p className="text-xs sm:text-sm text-stone-600 font-light pt-3 leading-relaxed">
                          {faq.a}
                        </p>
                      </motion.div>
                    )}
